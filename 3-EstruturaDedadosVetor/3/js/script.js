...
function produtoEscalar(conjuntoIntercalado) {
    let produtoEscalar = 0;

    for (let i = 0; i < conjuntoIntercalado.length; i += 2) {
        produtoEscalar += conjuntoIntercalado[i] * conjuntoIntercalado[i + 1];
    }
...
function onButtonGerar() {
    ...
    outFatorial.innerHTML = '<Strong>ProdutoEscalar: ' + produtoEscalar(intercalarConjuntos(vetor, vetor2));
}